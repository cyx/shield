Gem::Specification.new do |s|
  ...
  s.files = ["lib/shield/helpers.rb", "lib/shield/login.rb", "lib/shield/password.rb", "lib/shield/template/basic_user.rb", "lib/shield/template/flexi_user.rb", "lib/shield/template/user.rb", "lib/shield.rb", "README.markdown", "README.rb", "LICENSE", "Rakefile", "test/basic_user_test.rb", "test/flexi_user_test.rb", "test/helper.rb", "test/login_middleware_test.rb", "test/login_rack_mounting_test.rb", "test/mounted_middleware_test.rb", "test/password_hash_test.rb", "test/shield_test.rb", "test/sinatra_test.rb", "test/user_test.rb"]
